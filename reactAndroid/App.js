...
class App extends React.Component {
  ...
  async getBluetoothAdapter () {
    try {
      let bluetoothAdapter = await BluetoothAdapter.getBluetoothAdapter()
      let pairedDevices = await BluetoothAdapter.getPairedDevices()
  ...
  startBluetoothServer () {
    BluetoothAdapter.bluetoothServerInitial((err) => {
      console.log('err ', err)
    }, () => {
